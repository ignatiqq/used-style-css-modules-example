...
// @ts-ignore
import {importAssets} from 'wepback-imported';

type ChunkStatsType = string[];

type ChunkLoadingTrackerType = {
    /**
     * requestedChunks contains "webpackChunkName" keys
     */
    requestedChunks: Map<string, ChunkStatsType>;
...
export class ChunkLoadingTracker implements ChunkLoadingTrackerType {
    ...
    requestedChunks: Map<string, ChunkStatsType> = new Map();
